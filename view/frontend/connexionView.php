...
<div class="masthead" id="connexionSection">
    <div class="container d-flex h-100 align-items-center">
        <div class="mx-auto text-center">
            ...
            <h2 class="text-white-50 mx-auto mt-2 mb-5">Se connecter | <a href="inscriptionView.php">S'inscrire</a></h2>
            <form class="form-inline d-flex flex-column">
                ...
                <p class="text-white-50">Pas encore membre ? <a href="inscriptionView.php">Je m'inscris !</a></p>
